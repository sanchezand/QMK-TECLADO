...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_ESC, 	KC_1, 	KC_2, 	KC_3, 	KC_4, 	KC_5, 	KC_6, 	KC_7,		KC_8, 	KC_9, 	KC_0, 	ES_APOS,	ES_IEXL,	KC_BSPC, 	KC_DEL, 
		KC_TAB, 	KC_Q, 	KC_W, 	KC_E, 	KC_R, 	KC_T, 	KC_Y, 	KC_U, 	KC_I, 	KC_O, 	KC_P, 	ES_GRV,	ES_PLUS,	KC_ENT, 		KC_HOME, 
		KC_CAPS,	KC_A, 	KC_S, 	KC_D, 	KC_F, 	KC_G, 	KC_H, 	KC_J,		KC_K, 	KC_L, 	ES_NTIL,	KC_QUOT,	KC_NUHS,					KC_PGUP, 
		KC_LSFT,	ES_LESS,	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 	KC_N, 	KC_M, 	KC_COMM,	KC_DOT, 	ES_MINS,	KC_RSFT,	KC_UP, 		KC_END, 
		KC_LCTL,	KC_LGUI,	KC_LALT, 									KC_SPC, 							KC_RALT,	MO(1),	KC_RCTL,	KC_LEFT,	KC_DOWN,		KC_RGHT),

	KEYMAP(
		KC_GRV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(2), 
